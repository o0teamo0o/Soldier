...
//https://github.com/o0teamo0o/pinyinjs
var PinYin = {
  "a": "\u554a\u963f\u9515",
...
function dataLetterSort(data, field) {
  ...
  for (var i = 0; i < resault.length; i++) {
    if (resault[i].list.length > 0) {
      var itemInfoList = resault[i].list;
      for (var j = 0; j < itemInfoList.length; j++) {
        var tempInfo = itemInfoList[j];
        tempInfo.letter = resault[i].letter;
        resultList.push(tempInfo)
      }
    }
  }
  return resultList;
...
module.exports = {
  ...
  getCapitalize: getCapitalize,
  dataLetterSort: dataLetterSort,
}